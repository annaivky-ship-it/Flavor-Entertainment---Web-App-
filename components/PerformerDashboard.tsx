        ...
        <nav className="-mb-px flex flex-wrap gap-x-4 gap-y-0">
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors flex items-center gap-2 ${
              activeTab === 'overview' ? 'border-orange-500 text-orange-400' : 'border-transparent text-zinc-400 hover:text-white hover:border-zinc-500'
            }`}
          >
          ...
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors flex items-center gap-2 ${
              activeTab === 'availability' ? 'border-orange-500 text-orange-400' : 'border-transparent text-zinc-400 hover:text-white hover:border-zinc-500'
            }`}
          >
          ...
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors flex items-center gap-2 ${
              activeTab === 'profile' ? 'border-orange-500 text-orange-400' : 'border-transparent text-zinc-400 hover:text-white hover:border-zinc-500'
            }`}
          >
                  ...
                  {isEditingProfile ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {SERVICE_AREAS.map(area => (
                        <label key={area} className={`flex items-center gap-3 p-4 rounded-xl border cursor-pointer transition-all ${
                          profileForm.service_areas.includes(area as any) 
