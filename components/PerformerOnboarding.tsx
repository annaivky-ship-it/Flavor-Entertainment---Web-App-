  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-[#b8b8c2]">Join our exclusive network of entertainers.</p>
      </div>

      {step === 1 && (
        <div className="card-base !p-8 space-y-6 animate-fade-in">
          <h2 className="text-xl font-semibold text-white border-b border-[#2a2a35] pb-4">Basic Information</h2>
          ...
          <InputField
            ...
            icon={<User className="w-5 h-5 text-[#8888a0]" />}
            required
          />
          ...
          <InputField
            ...
            icon={<Tag className="w-5 h-5 text-[#8888a0]" />}
            required
          />
          
          <div className="space-y-2">
            <label className="block text-sm font-medium text-[#b8b8c2]">Bio</label>
            <textarea
              value={formData.bio}
      ...
      {step === 2 && (
        <form onSubmit={handleSubmit} className="card-base !p-8 space-y-6 animate-fade-in">
          <h2 className="text-xl font-semibold text-white border-b border-[#2a2a35] pb-4">Services & Areas</h2>
          
          <div className="space-y-4">
            <label className="block text-sm font-medium text-[#b8b8c2]">Services Offered</label>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {['Waitressing', 'Strip Show', 'Promotional & Hosting'].map(service => (
                <label key={service} className="flex items-center gap-3 p-3 rounded-xl border border-[#2a2a35] hover:border-[#2a2a35] bg-[#13131a]/50 cursor-pointer transition-colors">
                  <input
                    type="checkbox"
                    ...
                    className="w-4 h-4 rounded border-[#2a2a35] text-[#e6398a] focus:ring-[#e6398a]/20 bg-[#1a1a22]"
                  />
                  <span className="text-[#b8b8c2]">{service}</span>
                </label>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <label className="block text-sm font-medium text-[#b8b8c2]">Service Areas</label>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {(['Perth North', 'Perth South', 'Southwest', 'Northwest'] as ServiceArea[]).map(area => (
                <label key={area} className="flex items-center gap-3 p-3 rounded-xl border border-[#2a2a35] hover:border-[#2a2a35] bg-[#13131a]/50 cursor-pointer transition-colors">
                  <input
                    type="checkbox"
                    ...
                    className="w-4 h-4 rounded border-[#2a2a35] text-[#e6398a] focus:ring-[#e6398a]/20 bg-[#1a1a22]"
                  />
                  <span className="text-[#b8b8c2]">{area}</span>
                </label>
              ))}
            </div>
          </div>
      ...
      {step === 3 && (
        <div className="card-base !p-12 text-center space-y-6 animate-fade-in">
          ...
          <p className="text-[#b8b8c2] max-w-md mx-auto">
