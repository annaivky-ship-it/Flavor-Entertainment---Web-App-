    ...
    <footer className="mt-16 py-12 border-t border-zinc-800 bg-zinc-950/20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
          {/* Service Area Map Illustration from Screenshot */}
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            <div className="relative group">
              ...
              <svg 
                viewBox="0 0 100 100" 
                className="w-48 h-48 md:w-64 md:h-64 text-orange-500/30 drop-shadow-[0_0_15px_rgba(249,115,22,0.3)] animate-float"
                fill="none" 
                stroke="currentColor" 
                strokeWidth="1.5"
                strokeLinecap="round" 
              ...
              >
                {/* Recreating the polygon from the user's screenshot */}
                <path 
                ...
                <text x="30" y="55" className="text-[6px] fill-zinc-500 font-bold uppercase tracking-tighter pointer-events-none">Western Australia</text>
              </svg>
            </div>
          ...
          <div className="flex flex-col items-center md:items-end space-y-6">
            <div className="flex flex-col items-center md:items-end">
              ...
              <span className="font-logo-sub text-xs text-zinc-600 -mt-1 tracking-widest">entertainers</span>
            </div>
        ...
        <div className="pt-8 border-t border-zinc-900 text-center text-zinc-600">
          <p className="text-sm">&copy; {new Date().getFullYear()} Flavor Entertainers. All Rights Reserved.</p>
          <p className="text-[10px] uppercase tracking-[0.2em] mt-2 font-bold opacity-50">Professional & Discrete Services</p>
        </div>
      </div>
    </footer>
  );
