...
const DEMO_SCENARIOS: DemoScenario[] = [
    {
        ...
        color: 'emerald',
        outcome: 'Γ£à Auto-approved ΓåÆ Payment step',
        riskScore: 12,
        riskLevel: 'SAFE',
    },
    {
        ...
        color: 'amber',
        outcome: 'ΓÜá∩╕Å Flagged ΓåÆ Manual admin review',
        riskScore: 47,
        riskLevel: 'REVIEW',
    },
    {
        ...
        color: 'red',
        outcome: 'Γ¥î Silently rejected at screening',
        riskScore: 88,
        riskLevel: 'BLOCK',
    },
    {
        ...
        color: 'blue',
        outcome: 'ΓÜí KYC bypassed ΓåÆ Direct payment',
        riskScore: 0,
        riskLevel: 'SAFE',
    },
];
...
const WALKTHROUGH_STEPS: WalkthroughStep[] = [
    ...
    {
        id: 'dns-check',
        title: 'Step 2 ΓÇö Instant DNS Safety Check',
        body: 'The moment a booking is submitted, the system runs an instant Do-Not-Serve check.\n\nClient email and phone are SHA-256 hashed with a private pepper and matched against the safety register ΓÇö all without storing raw contact details.',
        safetyNote: 'DNS check is synchronous and invisible to the client. Blocked clients receive generic "not available" responses.',
    },
    {
        id: 'kyc',
        title: 'Step 3 ΓÇö Identity Verification (KYC)',
        body: 'New clients are redirected to Didit\'s hosted verification page.\n\nThey upload a government ID, complete a liveness selfie check, and pass AML/sanctions screening ΓÇö all without leaving your platform flow.',
        safetyNote: 'Raw ID images are never stored. Only verification session IDs and pass/fail results are retained.',
    },
    {
        id: 'risk-score',
        title: 'Step 4 ΓÇö Risk Scoring Engine',
        body: 'After KYC, a 6-factor risk score (0ΓÇô100) is calculated:\n\nΓÇó Identity verification result\nΓÇó DNS register matches\nΓÇó Repeat client history\nΓÇó Failed verification attempts\nΓÇó Booking behaviour patterns\nΓÇó Device fingerprint analysis',
        safetyNote: 'Score Γëñ30: Auto-approve. 31ΓÇô60: Manual review. ΓëÑ61: Auto-reject.',
    },
    {
        id: 'admin-review',
        title: 'Step 5 ΓÇö Admin Review Queue',
    ...
    {
        id: 'payment',
        title: 'Step 6 ΓÇö Deposit Payment',
        ...
        safetyNote: 'Performer contact details are only released after deposit is paid ΓÇö protecting both sides.',
    },
    {
    ...
    },
    {
        ...
        body: 'This platform is available as a white-label SaaS for entertainment agencies.\n\nEvery feature you\'ve seen ΓÇö KYC, DNS, risk scoring, performer safety tools ΓÇö is production-ready and connects to live services.',
                    ...
                    {activeScenario ? (
                        <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-5 space-y-4">
                            <div className="flex items-center justify-between">
                                <h3 className="font-bold text-white">{activeScenario.label} ΓÇö System Response</h3>
                            ...
                            <div>
                                ...
                                <div className="flex justify-between text-xs text-zinc-500 mt-1">
                                    <span>0 ΓÇö Safe</span>
                                    <span>30</span>
                                    <span>60</span>
                                    <span>100 ΓÇö Block</span>
                                </div>
                            </div>
                            ...
                            <p className="text-xs text-zinc-500 leading-relaxed">
                                {activeScenario.id === 'safe' && 'Identity confirmed via Didit. No DNS matches. Score below threshold ΓÇö booking auto-approved and moved to payment step.'}
                                ...
                                {activeScenario.id === 'trusted' && 'Client verified 94 days ago with clean history. KYC bypassed. Booking moves directly to payment ΓÇö saving 2ΓÇô5 minutes per returning client.'}
                            </p>
                        </div>
                    ) : (
