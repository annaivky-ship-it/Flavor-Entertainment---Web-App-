...
const Header: React.FC<HeaderProps> = ({ children, searchQuery, onSearchChange, onNavigate, notificationUserId }) => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {/* Notification bell — shown between search and children when user is authenticated */}
