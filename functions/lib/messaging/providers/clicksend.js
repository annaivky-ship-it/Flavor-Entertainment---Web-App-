...
exports.sendClickSendSms = sendClickSendSms;
async function sendClickSendSms(to, body, config) {
    ...
    if (!username || !apiKey)
        throw new Error('ClickSend credentials missing');
...
//# sourceMappingURL=clicksend.js.map