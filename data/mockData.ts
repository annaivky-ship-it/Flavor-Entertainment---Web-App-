...
export const mockBookings: Booking[] = [
    ...
    {
        id: 'e5d4c3b2-a1f0-9876-5432-1fedcba09876',
        performer_id: 5,
        client_uid: 'test-client-uid-001',
        performer_uid: 'test-performer-uid-005',
        client_name: 'Test Client',
        client_email: 'test@example.com',
        client_phone: '0400111222',
        client_dob: '1995-06-15',
        event_date: '2026-04-12',
        event_time: '20:00',
        event_address: '42 Test Lane, Subiaco WA 6008',
        event_type: 'Bucks Party',
        ...
        duration_hours: 3,
        number_of_guests: 12,
        services_requested: ['waitress-topless', 'show-pearl'],
        verified_by_admin_name: null,
        verified_at: null,
        client_message: 'Test booking — please make sure everything runs smoothly!',
        performer: { id: 5, name: 'April Flavor' },
        performer_eta_minutes: null,
    }
];
